        ...
        <Layout className="pt-16">
            <div className="flex items-center justify-between w-full">
                ...
                <div className="w-1/2 ">
                    ...
                    Te invito a conocerme un poco más, para facilitarte esa tarea te dejo aquí debajo mi hoja de vida y un botón mágico para que nos pongamos en contacto si quieres.
                    </p>
