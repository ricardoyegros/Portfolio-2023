            ...
            <div className="flex items-center justify-between w-full">
                ...
                <div className="w-1/2 ">
                    ...
                    <div className="flex items-center self-start mt-2">
                        <Link to="/CVFinalRicardoYegros (1).pdf" target={"_blank"} download={true} className="flex items-center bg-dark text-light p-2.5 px-6 rounded-lg text-lg font-montserrat font-semibold hover:bg-light hover:text-dark border-2 border-solid border-transparent hover:border-dark transition-all ease-in duration-300">Descarga mi CV</Link>
