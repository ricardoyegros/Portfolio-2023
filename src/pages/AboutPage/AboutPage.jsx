    ...
    <Layout className="pt-12 sm:pt-14">
      ...
      <div className="grid w-full grid-cols-8 gap-16 mt-12 sm:mt-8 place-items-center sm:flex sm: flex-col">
        <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8 ">
          ...
          <p className={`font-medium font-montserrat ${!darkMode ? "text-dark" : "text-light"} sm:text-justify sm:text-sm`}>
          ...
          <p className={`font-medium font-montserrat mt-4 ${!darkMode ? "text-dark" : "text-light"} sm:text-justify sm:text-sm`}>
        ...
        <div className={`col-span-3 relative h-max rounded-2xl border-2 shadow-lg shadow-black border-solid ${!darkMode ? "border-primary bg-light" : "border-primaryDark bg-dark"} p-8 xl:col-span-4 md:order-1 md:col-span-8 `}>
        ...
        <p className={`font-medium font-montserrat mt-4 sm:pt-0 md:order-2 ${!darkMode ? "text-dark" : "text-light"} sm:text-justify sm:text-sm`}>
